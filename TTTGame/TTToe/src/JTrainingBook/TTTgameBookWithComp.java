...
public class TTTgameBookWithComp extends JApplet implements MouseListener
{
	...
	bttnReset.addMouseListener(this);
	
	Font bttnFont = new Font("Times New Roman", Font.PLAIN, 50);
	...
	bttnsPanel.setLayout(new java.awt.GridLayout(5,3));
    ...
    public void mouseClicked (MouseEvent evnt)
{
	...
	if (currntBttn.getText() == "") 
	{
		...
		do
		{
		    int NUMB =(int)((Math.random()*10)%9);
		    System.out.println(NUMB);
		    currntBttn = bttnArr[NUMB];
		    System.out.println(currntBttn.getName());
		  
		}
		while (currntBttn.getText()!="");
